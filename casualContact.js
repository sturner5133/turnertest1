...
$(function(){
	...
	(function(app){
		...
		app.loadNote = function(title){
			...
			var notes = app.getNotes(),
				...
				page = ['<div data-role="page">',
						'<div data-role="header" data-position="fixed"><h1>Casual Contact</h1>',
						'<div data-role="navbar">',
						'<ul>',
						'<li><a href="#casual_view">View Casual List</a></li>',
						'<li><a href="#new_casual">New Casual</a></li>',
		...
		app.addNote = function(title, note, fname, lname, city, state, phone, zip, response, area){
			var notes = localStorage['casual_Contact'],
				notesObj;
			...
			localStorage['casual_Contact'] = JSON.stringify(notesObj);
		...
		app.deleteNote = function(key){
			...
			$.mobile.changePage('casual_list.html');
